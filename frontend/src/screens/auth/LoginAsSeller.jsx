      ...
      <section className="regsiter pt-16 relative">
        ...
        <form onSubmit={handleLogin} className="bg-white shadow-s3 w-1/3 m-auto my-16 p-8 rounded-xl">
          ...
          <p className="text-center mt-5">
            By clicking the become a seller button, you sell products, and you agree to Bidworld <span className="text-green underline"><a href="/terms">Terms & Conditions</a></span> &
