      ...
      <section className="regsiter pt-16 relative">
        ...
        <form onSubmit={handleRegister} className="bg-white shadow-s3 w-1/3 m-auto my-16 p-8 rounded-xl">
          ...
          <p className="text-center mt-5">
            By clicking the signup button, you create a Bidworld account, and you agree to Bidworld <span className="text-green underline"> <a href="/terms">Terms & Conditions</a></span> &
